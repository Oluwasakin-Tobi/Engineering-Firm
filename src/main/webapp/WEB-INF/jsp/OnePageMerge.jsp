    ...
    <head>
        ...
        <style>
            :root {
                ...
                /* --section-4-bg-color: #111117; --section-4-bg-image: url('/assets/images/bg-7.jpg'); */
                --section-4-bg-color: #111117; --section-4-bg-image: url('/assets/images/engine3.jpg');
        ...
        <header id="header">
            ...
            <nav class="navbar navbar-expand top">
                <div class="container header">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="#" class="nav-link"><i class="fas fa-phone-alt mr-2"></i>+2348101899045</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link"><i class="fas fa-envelope mr-2"></i>abtcoolb7@gmail.com</a>
                        </li>
                    </ul>
            ...
            <nav class="navbar navbar-expand navbar-fixed sub">
                <div class="container header">
                    ...
                    <a class="navbar-brand light" href="/">
                        <span class="brand">
                            <span class="featured">
                                <span class="first">JI</span>
                            </span>
                            <span class="last">SUN</span>
                        </span>
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item">
                            <a href="#projects" class="smooth-anchor nav-link">PROJECTS</a>
                        </li>
                        <li class="nav-item">
                            <a href="#funfacts" class="smooth-anchor nav-link">RESULTS</a>
                        </li>
                    </ul>
            ...
            <div class="swiper-container no-slider animation slider-h-100 slider-h-auto">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <!-- Media -->
                        <!-- <img src="assets/images/bg-5.jpg" alt="Full Image" class="full-image" data-mask="0"> -->   
                        
                        <img src="assets/images/engine3.jpg" alt="Full Image" class="full-image" data-mask="0" height="1920" width="943">  
                            ...
                            <div class="col-12 d-flex justify-content-start inner">
                                <div class="left text-left">
                                    ...
                                    <h1 data-aos="zoom-in" data-aos-delay="2000" class="title effect-static-text">
                                        <span class="pre-title m-0">McJohnson Jr.</span>
                                        LIFE <span class="featured"><span>ENGINEER</span></span>
                                    </h1>
                                    <p data-aos="zoom-in" data-aos-delay="2400" class="description bigger">Train your mind to see the bright side in any situation. Opportunities do not arise you create them.</p>
            ...
            <div class="container">
                <div class="row intro">
                    <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                        ...
                        <p>We are leaders in providing engineering services with a set of cutting-edge technologies and a team of experienced and renowned professionals. These are some options that you can hire.</p>
                    </div>
        ...
        <section id="about" class="section-2 odd highlights image-right featured">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 p-0 image">
                    ...
                    <img src="assets/images/engine2.jpg" class="fit-image" alt="Fit Image">
                </div>
            </div>
            </div>
        </section>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["innovation","social","technology"]'>
                            <div class="row card p-0 text-center">
                                <div class="image-over">
                                    ...
                                    <img src="assets/images/engine1.jpg" alt="Lorem ipsum">
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["institutional","events","environment"]'>
                            <div class="row card p-0 text-center">
                                <div class="image-over">
                                    ...
                                    <img src="assets/images/engine2.jpg" alt="Lorem ipsum">
                                </div>
                                <div class="card-caption col-12 p-0">
                                    <div class="card-body">
                                        <a href="#">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["technology","events","innovation"]'>
                            <div class="row card p-0 text-center">
                                <div class="image-over">
                                    ...
                                    <img src="assets/images/engine3.jpg" alt="Lorem ipsum">
                                </div>
                                <div class="card-caption col-12 p-0">
                                    <div class="card-body">
                                        <a href="#">
                                    ...
                                    <div class="row form-group-margin">
                                        ...
                                        <div class="col-12 col-md-6 m-0 p-2 input-group">
                                            ...
                                            <select name="info" class="form-control field-info">
                                                ...
                                                <option>Analytical Engineering</option>
