...
<html lang="en">
    ...
    <body class="home">
            ...
            <nav class="navbar navbar-expand navbar-fixed sub">
                <div class="container header">
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item">
                            <a href="#video" class="smooth-anchor nav-link">VIDEO</a>
                        </li>
                        <li class="nav-item">
                            <a href="#skills" class="smooth-anchor nav-link">SKILLS</a>
                        </li>
                    </ul>
                            ...
                            <div class="col-12 d-flex justify-content-start inner">
                                <div class="left text-left">
                                    ...
                                    <h1 data-aos="zoom-in" data-aos-delay="2000" class="title effect-static-text">
                                        <span class="pre-title m-0">Jacob Hill Jr.</span>
                                        LIFE <span class="featured"><span>COACH</span></span>
                                    </h1>
        ...
        <!-- Video -->
        <section id="video" class="section-3 odd highlights image-center featured">
        ...
        <!-- Skills -->
        <section id="skills" class="section-4 highlights image-right counter skills featured">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 pr-md-5 align-self-center text-center text-md-left text items">
                        <div data-aos="fade-up"  class="row intro">
                            <div class="col-12 p-0">
                                <span class="pre-title m-auto m-md-0">About the professional</span>
                                <h2><span class="featured"><span>The</span></span> Consultant</h2>
                                <p>Extensive consulting experience gained over many years of work in the professional and business qualification field.</p>
                            </div>
                        </div>
